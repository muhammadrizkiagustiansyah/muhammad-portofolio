        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-zinc-400 mt-6 max-w-xl leading-relaxed">
              I design intuitive digital experiences and transform
              them into responsive, functional, and user-friendly
              interfaces.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              {/* TODO: Masukkan CV PDF ke public/cv */}
          ...
          <div className="flex justify-center">
            ...
            <div className="relative">
              ...
              <div className="relative w-[280px] md:w-[380px] aspect-square rounded-[40px] overflow-hidden border border-white/10 bg-zinc-900">
                ...
                {/* TODO:
                    Masukkan foto kamu dengan nama:
